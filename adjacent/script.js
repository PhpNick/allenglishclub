Vue.component('button-bre-play', {
  ...
  template: `
  	...
  	BrE <img src="/allenglishclub/adjacent/img/listen-icon.svg" alt="">
  	</button>
  `
});
...
Vue.component('button-ame-play', {
  ...
  template: `
  	...
  	AmE <img src="/allenglishclub/adjacent/img/listen-icon.svg" alt="">
  	</button>
  `
});
...
Vue.component('exercise', {
  ...
  <div class="d-flex justify-content-end align-items-baseline">
    ...
    @click="check">
    <img src="/allenglishclub/adjacent/img/check.svg" alt="">
    Check</button></div>
  </div> 
  </div>     
  `
